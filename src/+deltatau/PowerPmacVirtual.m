classdef PowerPmacVirtual < deltatau.AbstractPowerPmac
    ...
    methods
        ...
        function this = PowerPmacVirtual()
            this.init();
        end
        ...
        function init(this)
            ...
            for k = 1:length(cParams)
                ...
                for j = 1:length(cLevels)
                    ...
                    for i = 1:3 % hydra channels
                        this.dMot.(cParams{k}).(cLevels{j}) = zeros(3, 2);
                    end
        ...
        function sendHydraCommand(this, u8Hydra, u8Val)
          fprintf('deltatau.PowerPmacVirtual.sendHydraCommand(%d,%d)\n', u8Hydra, u8Val);
        end
        ...
        function d = getMot(this, cParam, cLevel, u8Hydra, u8Axis)
            %fprintf('getMot(%s,%s,%d,%d)\n',cParam, cLevel, u8Hydra, u8Axis);
            d = this.dMot.(cParam).(cLevel)(u8Hydra, u8Axis);
        end
        ...
        function setMot(this, cParam, cLevel, u8Hydra, u8Axis, dVal)
            this.dMot.(cParam).(cLevel)(u8Hydra, u8Axis) = dVal;
        end
